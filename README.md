...
- `pamoja-loopback` - an in-process `Transport` with MQTT-style topic matching, so examples and tests exercise the full publish/subscribe path with no broker and no hardware.
